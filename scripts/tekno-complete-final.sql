-- TEKNO Ürünleri - EKSIKSIZ LISTE (15 ÜRÜN)
-- Tüm fiyatlar, paket boyutları ve malzeme uyumluluğu DOĞRU!
...
-- 15. TEKNOLATEX 400 - Dekoratif Sıva Altı Astar (25 KG)
-- USD Fiyat: 32.50 USD/paket → TL: 32.50 × 43.70 = 1420.25 TL
-- Liste: 1420.25 TL/paket → İskontolu Satış: 862.27 TL/paket
INSERT INTO accessories (
  brand_id, accessory_type_id, name, short_name, unit, unit_content,
  base_price, is_for_eps, is_for_tasyunu, discount_1, discount_2,
  is_kdv_included, is_active
) VALUES (
  6, 6, 'TEKNOLATEX 400', 'Latex Astar', 'KOVA', 25,
  1420.25, true, true, 40, 8,
  true, true
);
...
-- ✅ ÖZET:
-- ═══════════════════════════════════════════════════════════════════════════
-- 📦 Toplam: 15 TEKNO ürünü
-- 💰 Fiyatlar: AMBALAJ FİYATI (liste fiyatı, KDV dahil)
-- 📊 İskontolar: %40 + %8, Kar marjı: %10
-- 🎯 Dübel Seçimi:
--    • Çelik 115mm → TAŞYÜNÜ 3-6 cm
--    • Çelik 155mm → TAŞYÜNÜ 7-10 cm
--    • Plastik 10cm → EPS 3-6 cm
--    • Plastik 12cm → EPS 7-10 cm
-- 🔢 Hesaplama: (m² × 6 adet/m²) ÷ 500 adet/paket
-- 💵 Dolar Kuru: 43.70 TL (LATEX için)
-- ═══════════════════════════════════════════════════════════════════════════
